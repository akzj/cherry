...
var ScrollU = React.forwardRef(function (props, ref) {
    var className = props.className, renderItem = props.renderItem, _a = props.initialItems, initialItems = _a === void 0 ? [] : _a, _b = props.showScrollBar, showScrollBar = _b === void 0 ? true : _b, _c = props.scrollBarRender, scrollBarRender = _c === void 0 ? function (height, top) { return (jsxRuntime.jsx(DefaultScrollBar, { height: height, top: top })); } : _c;
    var containerRef = React.useRef(null);
    var contentRef = React.useRef(null);
    var _d = React.useState(0), translateY = _d[0], setTranslateY = _d[1];
    var _e = React.useState({ height: 0, top: 0 }), scrollBar = _e[0], setScroll = _e[1];
    var clearButtonTimer = React.useRef(null);
    var clearTopItemTimer = React.useRef(null);
    var _f = React.useState(initialItems), items = _f[0], setItems = _f[1];
    var _g = React.useState(false), isLoadingPre = _g[0], setIsLoadingPre = _g[1];
    var _h = React.useState(false), isLoadingNext = _h[0], setIsLoadingNext = _h[1];
    ...
    var _j = React.useState(false), pendingPreAdjust = _j[0], setPendingPreAdjust = _j[1];
    var handlePre = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var first, currentMsgId, newItems_1, currentTranslateY, oldHeight;
        var _a;
            ...
            switch (_b.label) {
                case 0:
                    ...
                    if (first && React.isValidElement(first)) {
                        currentMsgId = (_a = first.props) === null || _a === void 0 ? void 0 : _a.msgId;
                ...
                case 1:
                    _b.trys.push([1, , 3, 4]);
                    return [4 /*yield*/, renderItem('pre', first)];
                case 2:
                    newItems_1 = _b.sent();
    ...
    var handleNext = React.useCallback(function () { return __awaiter(void 0, void 0, void 0, function () {
        var last, currentMsgId, newItems_2;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    if (isLoadingNext || !renderItem)
                        return [2 /*return*/];
                    last = items.length > 0 ? items[items.length - 1] : undefined;
                    if (last && React.isValidElement(last)) {
                        currentMsgId = (_a = last.props) === null || _a === void 0 ? void 0 : _a.msgId;
                ...
                case 1:
                    ...
                    return [4 /*yield*/, renderItem('next', last)];
                case 2:
                    newItems_2 = _b.sent();
    ...
    return (jsxRuntime.jsxs("div", { ref: containerRef, className: cn('relative h-full w-full overflow-hidden border', className), children: [jsxRuntime.jsx("div", { ref: contentRef, style: {

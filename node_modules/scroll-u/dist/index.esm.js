...
import React, { forwardRef, useRef, useState, useCallback, useImperativeHandle, useEffect, useLayoutEffect } from 'react';
...
var ScrollU = forwardRef(function (props, ref) {
    var className = props.className, renderItem = props.renderItem, _a = props.initialItems, initialItems = _a === void 0 ? [] : _a, _b = props.showScrollBar, showScrollBar = _b === void 0 ? true : _b, _c = props.scrollBarRender, scrollBarRender = _c === void 0 ? function (height, top) { return (jsx(DefaultScrollBar, { height: height, top: top })); } : _c;
    var containerRef = useRef(null);
    var contentRef = useRef(null);
    var _d = useState(0), translateY = _d[0], setTranslateY = _d[1];
    var _e = useState({ height: 0, top: 0 }), scrollBar = _e[0], setScroll = _e[1];
    var clearButtonTimer = useRef(null);
    var clearTopItemTimer = useRef(null);
    var _f = useState(initialItems), items = _f[0], setItems = _f[1];
    var _g = useState(false), isLoadingPre = _g[0], setIsLoadingPre = _g[1];
    var _h = useState(false), isLoadingNext = _h[0], setIsLoadingNext = _h[1];
    ...
    var _j = useState(false), pendingPreAdjust = _j[0], setPendingPreAdjust = _j[1];
    ...
    return (jsxs("div", { ref: containerRef, className: cn('relative h-full w-full overflow-hidden border', className), children: [jsx("div", { ref: contentRef, style: {

...
const Sidebar: React.FC<SidebarProps> = ({
    ...
    return (
        <>
            <div className="w-80 bg-gray-800 bg-opacity-75 backdrop-blur-md text-white flex flex-col h-full border-r border-gray-700">
                <div className="p-4 border-b border-gray-700">
                    <div className="flex justify-between items-center mb-4">
                        ...
                        <button className="p-2 rounded-full bg-gray-700 hover:bg-gray-600 transition-colors" onClick={() => setIsSettingsOpen(true)}>
            ...
            {isSettingsOpen && (
                <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-50 flex items-center justify-center">
                    <div className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-md rounded-lg shadow-xl w-full max-w-4xl h-[90vh] relative overflow-hidden">
                        <button
